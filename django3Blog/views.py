...
from access_statistics.utils import get_seven_days_read_data, get_day_hot_data, get_days_hot_data
...
def home(request):
    ...
    today_hot_data = get_day_hot_data(blog_content_type, 0)
    yesterday_hot_data = get_day_hot_data(blog_content_type, 1)
